...
**API:** [http://localhost:3333/health/ready](http://localhost:3333/health/ready) → `status: ok`  
**Portal:** [http://localhost:5173/login](http://localhost:5173/login)  


| #   | Cenário                                              | Passou? | Evidência (print/arquivo) | Observação                                         |
| --- | ---------------------------------------------------- | ------- | ------------------------- | -------------------------------------------------- |
| 1   | Nova cobrança — vencimento = hoje (após 21h BRT)     | ☐       |                           | Sem HTTP 422 indevido                              |
| 2   | Detalhe boleto — reprocesso sem endereço             | OK      |                           | Toast/422 legível; status não vai a agendado à toa |
| 3   | Detalhe boleto — após reprocesso                     | OK      |                           | Um banner por vez (sem erro antigo + andamento)    |
